...
class AppointmentsController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $query = Appointment::with(['hauler', 'creator', 'yard','gatepass'])->select(sprintf('%s.*', (new Appointment)->table));
    ...
    public function printPass(){
        abort_if(Gate::denies('appointment_print_pass'), Response::HTTP_FORBIDDEN, '403 Forbidden');
