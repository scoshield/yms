...
class AppointmentsController extends Controller
{
    ...
    public function printPass(Request $request){
        ...
        $qrCode = base64_encode(QrCode::format('png')->size(256)->generate($request->ref));//QrCode::generate($request->ref);
        //base64_encode(QrCode::format('png')->size(256)->generate('https://google.com'))
