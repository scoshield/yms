        ...
        if ($request->ajax()) {
            ...
            $table->editColumn('duration', function ($row) {
                ...
                if($row->started_at && $row->finished_at){
                    $duration = \Carbon\Carbon::parse($row->started_at)->diffForHumans(\Carbon\Carbon::parse($row->finished_at));
                    //->diffInMinutes(\Carbon\Carbon::parse($row->finished_at));
                    ...
                    return $interval->format('%d')." Days ".$interval->format('%h')." Hours ".$interval->format('%i')." Minutes";
                }
