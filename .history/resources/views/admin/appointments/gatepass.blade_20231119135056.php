...
<div style="text-align:right;">
    ...
    <table style="line-height: 1.5;">
        ...
        <tr>
            ...
            <td style="text-align:right;">Hauler Name</td>
        </tr>
        <tr>
            <td></td>
        ...
        <table style="line-height: 2;">
            <thead>
                <tr style="font-weight: bold;border:1px solid #cccccc;background-color:#f2f2f2;">
                    <td style="border:1px solid #cccccc;width:200px;">Cargo Description</td>
            ...
            <tbody>
                <tr>
                    <td style = "text-align:right;border:1px solid #cccccc;width:500px">Some stuff</td>
                    {{-- <td></td>
                    <td></td>
                    <td></td> --}}
                </tr>
