                ...
                <div class="card-body">
                    ...
                    <table class="w-100 table-sm table-striped table-bordered p-0">
                        ...
                        @if ($appointment->offloading)
                            ...
                            <tr>
                                <td colspan="3"><span style="font-weight: bold; float: right;">T.A.T</span></td>@php $time =+ dateDifference($appointment->offloading->finished_at, $appointment->offloading->started_at); @endphp
